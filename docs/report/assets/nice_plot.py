...
# inches = points / 72
plt.figure(figsize=(TEXT_WIDTH / 72.0 * 0.48, 2.5))
...
plt.plot(x, y2, lw=1.5, color=COLORS[1], ls="--", label=r"$\sin(2 \pi x) e^{-\frac{1}{10} x}$")
plt.plot(x, y1, lw=1.5, color=COLORS[0], label=r"$\cos(2 \pi x) e^{-\frac{3}{4} x}$")
