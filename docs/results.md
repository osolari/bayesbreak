...
[`report/shared/figures/results/realdata_metrics.json`](https://github.com/osolari/bayesbreak/blob/master/report/shared/figures/results/realdata_metrics.json).
