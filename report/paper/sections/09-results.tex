...
All numerical values in this section are populated archived outputs. No experiment was rerun for this revision. The figures and tables retain their source sidecars; interpretation follows Section~\ref{sec:experimental-design}.
...
\centering
\small
\resizebox{0.88\textwidth}{!}{\input{shared/tables/results/table3_conjugate_summary.tex}}
...
\centering
\scriptsize
\resizebox{0.97\textwidth}{!}{\input{shared/tables/results/table4_nonconj_tradeoff.tex}}
