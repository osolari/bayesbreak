...
\resultid{RES-BB-SYN-005} & 400-run latent-group stress grid & real corrected execution & finite score-clustering stress behavior & valid for stated simulations, scoped \\
...
\resultid{RES-BB-CMP-003} & raw-matrix CGH comparator & real corrected execution & common-axis agreement with model-derived MAP & valid for stated diagnostic, scoped \\
...
\resultid{RES-BB-RD-008Q} & in-support Beta predictive blocks & real corrected execution & family-correct predictive evaluation & valid for stated blocks, scoped \\
\bottomrule
\end{tabularx}
\end{table}
